...
export default defineSchema({
  ...
  tours: defineTable({
    ...
    /** Province-level grouping for /guides and tour filters. */
  ...
  /** Customer-submitted tour reviews (moderated before display). */
  tourReviews: defineTable({
    ...
    /** Traveller-provided travel month/label, optional. */
    ...
    .index("by_tour", ["tourId"])
    .index("by_tour_and_status", ["tourId", "status"])
  ...
  destinations: defineTable({
    ...
    /** Parent province slug for cross-linking to /guides/[province]. */
  ...
  /** Provinces for /guides — south-to-north Pakistan journey. */
  provinces: defineTable({
    ...
    /** True when AI-created from a tour (kept out of the curated /guides list). */
    autoGenerated: v.optional(v.boolean()),
    createdAt: v.number(),
    updatedAt: v.number(),
  }).index("by_slug", ["slug"]),

  /** Historical/cultural/natural sites within a province. */
  sites: defineTable({
    ...
    .index("by_province_and_slug", ["provinceId", "slug"]),
