 ...
 * @since 1.3.0
 */
class Havezic_SiteLogo extends Elementor\Widget_Base
{
    /**
    ...
    public function get_title() {
        return esc_html__('Site Logo', 'havezic');
    }
    ...
    protected function register_content_site_logo_controls() {
        ...
        $this->add_control(
            'caption',
            [
                'label'       => __( 'Custom Caption', 'havezic' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => __( 'Enter caption', 'havezic' ),
                'condition'   => [
                    'caption_source' => 'yes',
                ],
                'dynamic'     => [
        ...
        $this->add_control(
            'link_to',
            [
                'label'   => __( 'Link', 'havezic' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => __( 'Default', 'havezic' ),
                    'none'    => __( 'None', 'havezic' ),
                    'file'    => __( 'Media File', 'havezic' ),
                    'custom'  => __( 'Custom URL', 'havezic' ),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'https://your-link.com', 'havezic' ),
                'condition'   => [
                    'link_to' => 'custom',
                ],
                'show_label'  => false,
    ...
    protected function register_site_logo_styling_controls() {
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Background Color', 'havezic' ),
        ...
        $this->add_control(
            ...
            [
                'label'       => __( 'Border Style', 'havezic' ),
                'type'        => Controls_Manager::SELECT,
                'default'     => 'none',
                'label_block' => false,
                'options'     => [
                    'none'   => __( 'None', 'havezic' ),
                    'solid'  => __( 'Solid', 'havezic' ),
                    'double' => __( 'Double', 'havezic' ),
                    'dotted' => __( 'Dotted', 'havezic' ),
                    'dashed' => __( 'Dashed', 'havezic' ),
                ],
                'selectors'   => [
        ...
        $this->add_responsive_control(
            'image_border_radius',
            [
                'label'              => __( 'Border Radius', 'havezic' ),
                'type'               => Controls_Manager::DIMENSIONS,
                'size_units'         => [ 'px', '%' ],
                'selectors'          => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Transition Duration', 'havezic' ),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max'  => 3,
        ...
        $this->add_control(
            'hover_animation',
            [
                'label' => __( 'Hover Animation', 'havezic' ),
...
$widgets_manager->register(new Havezic_SiteLogo());