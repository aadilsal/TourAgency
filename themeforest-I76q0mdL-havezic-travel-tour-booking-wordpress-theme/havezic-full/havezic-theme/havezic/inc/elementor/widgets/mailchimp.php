...
if (!havezic_is_mailchimp_activated()) {
    return;
}
...
class Havezic_Elementor_Mailchimp extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'havezic-mailchimp';
    }

    public function get_title()
    {
        return esc_html__('MailChimp Sign-Up Form', 'havezic');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Placeholder', 'havezic'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'input_color_border',
            [
                'label' => esc_html__('Color Border', 'havezic'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            [
                'label' => esc_html__('Focus', 'havezic'),
            ]
        );
        ...
        $this->add_control(
            'button_icon_hover',
            [
                'label' => esc_html__('Icon Color hover', 'havezic'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Border Color hover', 'havezic'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Havezic_Elementor_Mailchimp());
