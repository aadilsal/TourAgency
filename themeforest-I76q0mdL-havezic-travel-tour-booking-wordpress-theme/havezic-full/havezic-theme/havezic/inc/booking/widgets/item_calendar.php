...
class Havezic_BABE_Elementor_Itemcalendar_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Detail Calendar', 'havezic' );
	}
    ...
    protected function title_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Calendar & Prices', 'havezic' ),
                'condition' => [
                    'enable_title' => 'yes',
                ]
            ]
...
$widgets_manager->register(new Havezic_BABE_Elementor_Itemcalendar_Widget());
