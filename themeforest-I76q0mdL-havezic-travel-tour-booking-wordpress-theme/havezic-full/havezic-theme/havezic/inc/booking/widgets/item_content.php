...
class Havezic_BABE_Elementor_Itemcontent_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Detail Content', 'havezic');
    }
    ...
    protected function render()
    {
        ...
        if ( is_single() && $main_post->post_type == BABE_Post_types::$booking_obj_post_type) {
            if (!empty($main_post->post_content)){
                $this->title_render();
                echo '<div class="desc-p havezic-single-content">';
    ...
    protected function add_control_style_wrapper($condition = array())
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementor-widget-inner .havezic-single-content',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .elementor-widget-inner .havezic-single-content' => 'color: {{VALUE}};',
                ],
            ]
        );
...
$widgets_manager->register(new Havezic_BABE_Elementor_Itemcontent_Widget());
