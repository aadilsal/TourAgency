...
class Havezic_BABE_Elementor_ItemIncluded_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Detail Highlights', 'havezic');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'item_space',
            [
                'label'     => esc_html__('Item Spacing', 'havezic'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-list-items .item_icon svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-list-items .item_icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        if (is_single() && $babe_post->post_type == BABE_Post_types::$booking_obj_post_type) {
            $data = get_post_meta($post_id, 'havezic_included_section', 1);
            if(!empty($data) && is_array($data)){

                echo '<div class="elementor-widget-inner">';
                    echo '<ul class="elementor-list-items">';
                    foreach ($data as $datum){
                        if(isset($datum['havezic_included']) && !empty($datum['havezic_included'])){
                            echo '<li class="list-item">';
                                $this->render_icon($settings);
                                echo '<span class="list-text">'. esc_attr($datum['havezic_included']). '</span>';
                            echo '</li>';
                        }
                    }
                    echo '</ul>';
...
$widgets_manager->register(new Havezic_BABE_Elementor_ItemIncluded_Widget());