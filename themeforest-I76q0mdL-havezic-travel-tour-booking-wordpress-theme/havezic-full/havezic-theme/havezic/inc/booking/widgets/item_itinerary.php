...
class Havezic_BABE_Elementor_Item_Itinerary_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Detail Itinerary', 'havezic');
    }
    ...
    protected function render()
    {
        ...
        if ( is_single() && $main_post->post_type == BABE_Post_types::$booking_obj_post_type) {
            ...
            $babe_post = BABE_Post_types::get_post($main_post->ID);

            $itinerary     = isset($babe_post['havezic_itinerary']) ? $babe_post['havezic_itinerary'] : false;
            if (isset($itinerary) && !empty($itinerary)){
                $this->title_render();
                echo '<div class="havezic-single-itinerary">';
                echo wpautop($itinerary);
                echo '</div>';
            }
        }
    ...
    protected function add_control_style_wrapper($condition = array())
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementor-widget-inner .havezic-single-itinerary',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .elementor-widget-inner .havezic-single-itinerary' => 'color: {{VALUE}};',
                ],
            ]
        );
...
$widgets_manager->register(new Havezic_BABE_Elementor_Item_Itinerary_Widget());
