...
class Havezic_BABE_Elementor_Bookingform_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Detail Booking form', 'havezic');
    }
    ...
    protected function render() {
        echo '<div class="elementor-widget-inner">';
            get_template_part('template-parts/booking/single/booking_form');
        echo '</div>';
    }
...
$widgets_manager->register(new Havezic_BABE_Elementor_Bookingform_Widget());