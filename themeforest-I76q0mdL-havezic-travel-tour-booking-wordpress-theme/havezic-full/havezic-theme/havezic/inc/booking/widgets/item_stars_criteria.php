...
class Havezic_BABE_Elementor_Itemstars_Criteria_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'babe-item-stars-criteria';
    }
    ...
    public function get_title() {
        return esc_html__('Detail Reviews Criteria', 'havezic');
    }
    ...
    protected function render() {
        ...
        get_template_part('template-parts/booking/single/star-criteria');
        echo '</div>';
    }
...
$widgets_manager->register(new Havezic_BABE_Elementor_Itemstars_Criteria_Widget());
