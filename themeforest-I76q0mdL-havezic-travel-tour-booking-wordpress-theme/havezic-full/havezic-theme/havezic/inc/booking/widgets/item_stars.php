...
class Havezic_BABE_Elementor_Itemstars_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Detail Reviews', 'havezic');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Reviews', 'havezic')
            ]
        );
...
$widgets_manager->register(new Havezic_BABE_Elementor_Itemstars_Widget());