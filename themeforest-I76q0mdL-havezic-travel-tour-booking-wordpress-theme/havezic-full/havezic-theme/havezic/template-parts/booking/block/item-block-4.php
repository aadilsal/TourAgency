...
?>
<div class="babe_items babe_items_4 babe_items_list <?php echo esc_attr($item_class);?>">
    <div class="babe_all_items_item_inner">
        ...
        <div class="item_text">
            ...
            <div class="excerpt-items">
                <?php echo BABE_Post_types::get_post_excerpt($post, $length = 40); ?>
            </div>
